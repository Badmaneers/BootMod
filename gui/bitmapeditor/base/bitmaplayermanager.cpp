...
BitmapLayerManager::BitmapLayerManager(QWidget *parent) : QWidget(parent)
{
    this->project = NULL;
...
BitmapLayerManager::~BitmapLayerManager() {
...
void BitmapLayerManager::setProject(Project *project)
{
...
Project *BitmapLayerManager::getProject() const
{
    return this->project;
}

void BitmapLayerManager::updateLayerList()
{
...
void BitmapLayerManager::selectMode(ProjectEditMode_t mode)
{
    switch (mode) {
    case PROJECT_EDIT:
...
void BitmapLayerManager::changeEvent(QEvent * event)
{
    // vzdy fixni velikost
...
void BitmapLayerManager::updateLayerControllBinding()
{
...
void BitmapLayerManager::on_project_repaintSignal(Layer *layer)
{
...
void BitmapLayerManager::on_project_layerListChanged()
{
    this->updateLayerList();
    this->updateLayerControllBinding();
}
...
/*********************************************************************************************************************/
// BitmapLayerManager - EVENTY PRO OVLADACI PRVKY
/*********************************************************************************************************************/

void BitmapLayerManager::addLayer()
{
    if(this->project == NULL) {
        QMessageBox::warning(
                    this,
...
void BitmapLayerManager::removeLayer()
{
    if(this->project == NULL) {
        QMessageBox::warning(
                    this,
...
void BitmapLayerManager::moveLayerUp()
{
    if(this->project == NULL) {
        QMessageBox::warning(
                    this,
...
void BitmapLayerManager::moveLayerDown()
{
    if(this->project == NULL) {
        QMessageBox::warning(
                    this,
...
void BitmapLayerManager::createOrRemoveMask() {
    if(this->project == NULL) {
        QMessageBox::warning(
                    this,
                    tr("Mask Add/Remove"),
...
void BitmapLayerManager::layerMergeDown()
{
    if(this->project == NULL) {
        QMessageBox::warning(
                    this,
...
void BitmapLayerManager::duplicateLayer()
{
    if(this->project == NULL) {
        QMessageBox::warning(
                    this,
...
void BitmapLayerManager::rasterizeLayer()
{
    if(this->project == NULL) {
        QMessageBox::warning(
                    this,
...
void BitmapLayerManager::activeOrDeactivateMask()
{
    if(this->project == NULL) {
        QMessageBox::warning(
                    this,
...
void BitmapLayerManager::renameLayer()
{
    if(this->project == NULL) {
        QMessageBox::warning(
                    this,
...
void BitmapLayerManager::on_listWidget_itemSelectionChanged()
{
...
void BitmapLayerManager::on_listWidget_itemDoubleClicked(QListWidgetItem *item)
{
    this->renameLayer();
}

void BitmapLayerManager::showContextMenu(const QPoint &pos)
{
...
void BitmapLayerManager::on_layer_antialiasing_toggled(bool value)
{
...
void BitmapLayerManager::on_layer_blend_changed(int index)
{
    if(this->project == NULL) return;
    Layer *l = this->project->getSelectedLayer();
    if(l == NULL) return;
...
void BitmapLayerManager::on_layer_opacity_changed(int value)
{
    if(this->project == NULL) return;
    Layer *l = this->project->getSelectedLayer();
    if(l == NULL) return;
...
void BitmapLayerManager::on_project_edit_mode_changed(int index)
{
    if(this->project == NULL) return;
    switch (index) {
    case 0:
