 ...
 */
class BitmapAppContext : public QObject {
    Q_OBJECT
public:
    /**
    ...
    /**
     * @brief Navrati pointer na BitmapLayerManager komponentu
     * @return BitmapLayerManager
     */
    BitmapLayerManager *getLayerManager() const;

    /**
     * @brief Aplikaci nastavi novy BitmapLayerManager
     * @param newLayerManager - Novy BitmapLayerManager
     * @return
     */
    void setLayerManager(BitmapLayerManager *newLayerManager);
...
protected:
    ...
    BitmapLayerManager *layerManager; /** Komponenta pro spravu vrstev projektu*/
...
private:
    ...
    Q_PROPERTY(BitmapLayerManager *layerManager READ getLayerManager WRITE setLayerManager NOTIFY layerManagerChanged)
};
